  ...
  audience: [
    {
      ...
      description: "Идеи для роста бизнеса, партнерств и масштабирования.",
      icon: "founder",
    },
    {
      title: "Инвесторам",
      description: "Взгляд на капитал, риски и современные инструменты.",
      icon: "investor",
    },
    {
      title: "Экспертам и руководителям",
      description: "Как усилить личный бренд, окружение и деловые связи.",
      icon: "leader",
    },
    {
      title: "Специалистам",
      description: "Как искусственный интеллект меняет рынок и профессии.",
      icon: "specialist",
    },
    {
      title: "Партнерам и командам",
      description: "Контакты, коллаборации и возможности для совместного роста.",
      icon: "partner",
    },
