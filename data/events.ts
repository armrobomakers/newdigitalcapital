  ...
  audience: [
    {
      ...
      description: "Новые идеи для роста бизнеса, партнерств и масштабирования.",
      icon: "founder",
    },
    {
      title: "Инвесторам",
      description: "Практический взгляд на капитал, риски и современные инструменты инвестирования.",
      icon: "investor",
    },
    {
      title: "Экспертам и руководителям",
      description: "Возможность усилить личный бренд, окружение и деловые связи.",
      icon: "leader",
    },
    {
      title: "Специалистам",
      description: "Понимание, как искусственный интеллект меняет рынок и профессии.",
      icon: "specialist",
    },
    {
      title: "Партнерам и командам",
      description: "Новые контакты, коллаборации и возможности для совместного роста.",
      icon: "partner",
    },
