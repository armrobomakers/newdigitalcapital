...
const ekbSeptemberEvent: EventData = {
  ...
  registration: {
    ...
    lead: "26 сентября · Екатеринбург · БЦ «Саммит», ул. 8 Марта, 51. Актуальный статус приема заявок определяется автоматически.",
    ...
    formLead: "Когда прием заявок доступен, команда свяжется с вами по указанному телефону после сохранения заявки.",
    tickets: [
      {
        id: "standard-1000",
        name: "Стандарт",
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Актуальный статус регистрации определяется автоматически. Если форма доступна, выберите тариф и оставьте контактные данные; если закрыта — на странице будет показан текущий статус.",
    },
    {
      question: "Можно ли стать партнером?",
      answer: "Партнерский формат находится в подготовке. Отдельный прием партнерских заявок будет включен после подтверждения условий и пакетов.",
    },
  ],
  location: {
    verified: true,
  ...
  footer: {
    ...
    ctaCopy: "Екатеринбург · БЦ «Саммит» · 12:00–17:00. Статус регистрации отображается на странице автоматически.",
    ctaButton: "Зарегистрироваться",
    participantLinks: [
    ...
    newsletterCopy: "Email организатора: armrobomakers@gmail.com. Телефон будет добавлен после подтверждения.",
  },
  contacts: {
